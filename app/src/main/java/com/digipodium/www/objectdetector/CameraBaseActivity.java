...
public abstract class CameraBaseActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener {
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)
                ...
                Toast.makeText(CameraBaseActivity.this,
    ...
    protected void setFragment() {
        ...
        cameraConnectionFragment.addConnectionListener((final Size size, final int rotation) -> CameraBaseActivity.this.onPreviewSizeChosen(size, rotation));
        cameraConnectionFragment.addImageAvailableListener(this);
        getSupportFragmentManager().beginTransaction().replace(R.id.container, cameraConnectionFragment).commit();
    }
