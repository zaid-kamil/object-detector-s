package com.digipodium.www.objectdetector.customview;
...
public class OverlayView extends View {
    ...
    public OverlayView(final Context context, final AttributeSet attrs) {
        ...
        resultsViewHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,10, getResources().getDisplayMetrics());
    }
